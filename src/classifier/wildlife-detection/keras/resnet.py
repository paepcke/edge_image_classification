...
def _bn_relu(x, bn_name=None, relu_name=None):
    ...
    """
    norm = BatchNormalization(axis=CHANNEL_AXIS, name=bn_name, momentum=BATCH_NORM_DECAY,
...
def _conv_bn_relu(**conv_params):
    ...
    kernel_regularizer = conv_params.setdefault("kernel_regularizer", l2(L2_WEIGHT_DECAY))
